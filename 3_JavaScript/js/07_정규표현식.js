...
document.getElementById("check1").addEventListener("click", function(){
    ...
    const str2 = "java, db, html, css, js, spring, mybaits 모두 사용중입니다.";
...
document.getElementById("check2").addEventListener("click",function(){
    ...
    // $(달러) : 문자열의 끝을 의미
    const regEx4 = /team$/;   //_team이라는 문자열로 끝나야함.
    div1.innerHTML += "/team$/ , A-team : " + regEx4.test("A-team") + "<hr>";
    div1.innerHTML += "/team$/ , team-A : " + regEx4.test("team-A") + "<hr>";
    
    
    // ^[ABCD]-team$ 
    // -> A-team / B-team / C-team / D-team이 맞으며 true, 아니면 false
    // -> https://regexr.com/에서 확인

    // [0-9] : 숫자
    // [a-z] : 영어 소문자   __ [a-d] : a~d까지
    // [A-Z] : 영어 대문자 

    // ^[A-Z][0-9]$ -> 시작은 영어 대문자, 끝은 숫자

    // 특수문자를 제외한 문자 하나 -> ^[a-zA-Z0-9]$  _한칸안에 영어대소문자,숫자 중 하나가 들어가야 함.
