...
document.getElementById("btn1").addEventListener("click", function(){
    ...
    console.log(arr3);  // []
    console.log(arr4);  // ['사과', '딸기', '바나나']
    
    // 배열에 존재하지 않는 인덱스에 값 대입
    // -> 자동으로 추가되면서 길이 증가  + 자료형 달라도 가능
    ...
    // ** 여러 요소를 얻어온 경우(HTMLColleciton, NodeList)는
    ...
    arr4.forEach(function(a, i){
        ...
        // 1 : 딸기
        // 2 : 바나나 
        //_ document.getElementsByTagName("li")
        //_ HTMLCollection(5) [li, li, li, li, li]; -> 혹은 List
        //_ 이건 배열이 아니라 유사 배열. -> forEach 쓸 수 없음!
    });



    // _for of 구문    
    // 3. for(item of 배열(또는 컬렉션)){} - 배열, 컬렉션에서 사용
    ...
    //_ 콘솔에서 열어보면 Prototype 안에 Symbol.iteratior를 볼 수 있는데, 이것이 유사배열을 의미
    ...
    //_ for in 구문
    // 4. for(let key in 객체) - JS 객체용 for문 //_배열용X
})
...
document.getElementById("btn2").addEventListener("click", function(){
    ...
    console.log(arr.toString());  //_toString() 생략 가능

    // 배열.pop() : 배열의 마지막 요소를 꺼내와서 반환
    ...
    // 숫자 정렬의 문제점과 해결 방법
    const numArr = [5, 3, 2, 10, 1];  // -> 오름차순 정렬 : 1, 2, 3, 5, 10   _이렇게 나와야 함.
