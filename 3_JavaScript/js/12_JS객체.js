...
document.getElementById("btn1").addEventListener("click", function(){
    ...
    const product = {
        ...
        'information' : function(){  // 객체의 기능
            ...
            // 해당 객체의 변수(key)가 아닌
            // 전역변수가 선택된다.
            // 왜? 같은 객체의 변수(key)를 선택하는 방법이 별도 존재하기 때문.
    ...
    // 객체의 값을 얻어오거나 대입하는 방법  _ 두 방법 모두 기억해야함!
    // 1) 얻어오기 : 객체명.key 
    //               객체명['key']
    // 2) 대입하기 : 객체명.key = 값;
    //               객체명['key'] = 값;
...
/*
이런 식으로 비어있는ㄴ 객체 만들어놓고 후에 값을 추가하기도 함.(자주 쓰는 방식)
const obj = {};
obj.test = 1;
obj.test2 = 2;*/
...
document.getElementById("btn2").addEventListener("click", function(){
    ...
    stdList.push( new Student(2, 5, "박길동"));
...
function Student(grade, ban, name) {
    ...
    // 속성
    this.grade = grade;
    // 매개변수 grade 값을 생성하는 객체의 grade에 대입
    this.ban = ban;
    this.name = name;
...
//_Java : JSON을 String 한 줄로 가져올 수 있음. -> jackson 라이브러리 : vo로 전환시켜줌
//_ Java 문자열 -> JSON 1개로 갖고 올 수 있음. .parse 사용.